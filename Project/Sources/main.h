...
#define ANALOG_SAMPLE_INTERVAL 1.25//0.0390625 //0.15625 //0.3125 //1.25 // we get this value from: period: 1/50 = 20 ms, we need 16 samples per period atleast so: 20 / 16 = 1.25
